...
public class Orchard2 {
	...
	public void specs(){
		...
		ConsoleIO.printLine("Apple/Pound cost: $"+appleCost);
		ConsoleIO.printLine("Cider/Gallon cost: $"+ciderCost);
		ConsoleIO.printLine("Set up cost: $"+startUpCost);
		ConsoleIO.printLine("Yearly revenue: $"+yearlyRevenue);
		yearsToProfit();
		ConsoleIO.printLine("");
	}
